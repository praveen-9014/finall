...
let refreshbtn = document.querySelector("header #left #new-chart")

let fulldetails = document.querySelector("main #full-details");

let chartbox = document.querySelector("#chat-container");

let home = document.querySelector(" header .navigation #nav #home a")
let benifits = document.querySelector(" header .navigation #nav #benifits a")
let bot = document.querySelector(" header .navigation #nav #MedBot a")
...
// ***************************************************************************************************************
let fruits = document.querySelector(".benifits-container");
console.log("praveen")
fruits.style.display = "flex"
benifits.addEventListener("click",()=>{
    console.log("praveen")
        fruits.style.display = "flexbox";
        fulldetails.style.display = "none";
})

home.addEventListener("click", () => {
    hideElements(fulldetails, chartbox);
});
